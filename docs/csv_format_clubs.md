...
```csv
club_id,club_name,manager_name,stadium_name,league,home_shirt_design,home_shirt_primary_r,home_shirt_primary_g,home_shirt_primary_b,home_shirt_secondary_r,home_shirt_secondary_g,home_shirt_secondary_b,home_shorts_r,home_shorts_g,home_shorts_b,home_socks_r,home_socks_g,home_socks_b
1,Arsenal,Mikel Arteta,Emirates Stadium,0,1,15,0,0,15,15,15,15,15,15,15,0,0
2,Liverpool,Jurgen Klopp,Anfield,0,0,15,0,0,15,15,0,15,0,0,15,0,0
```
